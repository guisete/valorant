...
export function LogoMarquee() {
  ...
  const logos = [
    ...
    { name: "MongoDB", content: "🟢", color: "text-[#ff1a3d]" },
    ...
    { name: "Kickstarter", content: "K", color: "text-white", bg: "bg-[#ff1a3d]" },
  ]
  ...
  const secondRowLogos = [
    ...
    { name: "TransferWise", content: "✓", color: "text-white", bg: "bg-[#ff1a3d]" },
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col items-center justify-between mb-12 sm:flex-row sm:items-center">
          <h2 className="text-4xl font-extrabold tracking-tight text-white sm:text-5xl text-center sm:text-left">
            Meet our <span className="text-[#ff1a3d]">top-tier</span>
            <br />
            customers
          </h2>
